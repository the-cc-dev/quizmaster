...
class QuizMaster_Controller_Statistics extends QuizMaster_Controller_Controller
{
    ...
    public static function ajaxLoadHistory($data)
    {
        ...
        foreach ($statisticModel as $model) {
            ...
            if (!$model->getUserId()) {
                ...
                if ($model->getUserName() == '') {
                    $model->setUserName(__('Deleted user', 'quizmaster'));
                }
            }
        ...
        $view = new QuizMaster_View_StatisticsAjax();
    ...
    public static function ajaxLoadStatisticUser($data)
    {
        ...
        $statisticRefMapper = new QuizMaster_Model_StatisticRefMapper();
        $statisticUserMapper = new QuizMaster_Model_StatisticUserMapper();
        $formMapper = new QuizMaster_Model_FormMapper();
        ...
        foreach ($statisticUsers as $statistic) {
            /* @var $statistic QuizMaster_Model_StatisticUser */
        ...
        $view->userName = __('Anonymous', 'quizmaster');
        ...
        if ($view->statisticModel->getUserId()) {
            ...
            if ($userInfo !== false) {
                ...
                $view->userName = __('Deleted user', 'quizmaster');
            }
        }
    ...
    {
        if (!current_user_can('quizMaster_reset_statistics')) {
            return;
        }
