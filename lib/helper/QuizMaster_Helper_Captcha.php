...
class QuizMaster_Helper_Captcha
{
    ...
    public function __construct()
    {
        ...
        $this->_captcha->tmp_dir = QUIZMASTER_CAPTCHA_DIR . '/';
    ...
    /**
     * @return QuizMaster_Helper_Captcha
     */
    public static function getInstance()
    {
        if (QuizMaster_Helper_Captcha::$INSTANCE == null) {
            QuizMaster_Helper_Captcha::$INSTANCE = new QuizMaster_Helper_Captcha();
        }

        return QuizMaster_Helper_Captcha::$INSTANCE;
    }
}