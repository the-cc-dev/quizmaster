 ...
 */
class QuizMaster_View_QuizEdit extends QuizMaster_View_View
{
    public function show()
    {
        ?>
        <style>
            .quizMaster_quizModus th, .quizMaster_quizModus td {
        ...
        <div class="wrap quizMaster_quizEdit">
            ...
            <form method="post"
                  action="admin.php?page=quizMaster&action=addEdit&quizId=<?php echo $this->quiz->getId(); ?>">

                <input type="hidden" name="ajax_quiz_id" value="<?php echo $this->quiz->getId(); ?>">

                <a style="float: left;" class="button-secondary"
                   href="admin.php?page=quizMaster"><?php _e('back to overview', 'quizmaster'); ?></a>
                ...
                <div id="poststuff">
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Quiz title', 'quizmaster'); ?><?php _e('(required)',
                                'quizmaster'); ?></h3>

                        <div class="inside">
                            <input name="name" id="quizMaster_title" type="text" class="regular-text"
                    ...
                    <?php do_action('quizMaster_action_plugin_quizEdit', $this); ?>

                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Options', 'quizmaster'); ?></h3>
                        ...
                        <div class="inside">
                            <table class="form-table">
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Hide quiz title', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Hide title', 'quizmaster'); ?></span>
                                            </legend>
                                            ...
                                            <p class="description">
                                                <?php _e('The title serves as quiz heading.', 'quizmaster'); ?>
                                            </p>
                                        </fieldset>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <?php _e('Hide "Restart quiz" button', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Hide "Restart quiz" button', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Hide "View question" button', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Hide "View question" button', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Display question randomly', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Display question randomly', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Display answers randomly', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Display answers randomly', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Sort questions by category', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Sort questions by category', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Time limit', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Time limit', 'quizmaster'); ?></span>
                                            </legend>
                                            <label for="time_limit">
                                                <input type="number" min="0" class="small-text" id="time_limit"
                                                       value="<?php echo $this->quiz->getTimeLimit(); ?>"
                                                       name="timeLimit"> <?php _e('Seconds', 'quizmaster'); ?>
                                            </label>

                                            <p class="description">
                                                <?php _e('0 = no limit', 'quizmaster'); ?>
                                            </p>
                                        </fieldset>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <?php _e('Statistics', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Statistics', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr id="statistics_ip_lock_tr" style="display: none;">
                                    <th scope="row">
                                        <?php _e('Statistics IP-lock', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Statistics IP-lock', 'quizmaster'); ?></span>
                                            </legend>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Execute quiz only once', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>

                                            <legend class="screen-reader-text">
                                                <span><?php _e('Execute quiz only once', 'quizmaster'); ?></span>
                                            </legend>
                                            ...
                                            <div id="quizMaster_quiz_run_once_type"
                                                 style="margin-bottom: 5px; display: none;">
                                                <?php _e('This option applies to:', 'quizmaster');
                                                ...
                                                <label>
                                                    ...
                                                    <?php _e('all users', 'quizmaster'); ?>
                                                </label>
                                                <label>
                                                    <input name="quizRunOnceType" type="radio"
                                                           value="2" <?php echo ($quizRunOnceType == 2) ? 'checked="checked"' : ''; ?>>
                                                    <?php _e('registered useres only', 'quizmaster'); ?>
                                                </label>
                                                <label>
                                                    <input name="quizRunOnceType" type="radio"
                                                           value="3" <?php echo ($quizRunOnceType == 3) ? 'checked="checked"' : ''; ?>>
                                                    <?php _e('anonymous users only', 'quizmaster'); ?>
                                                </label>

                                                <div id="quizMaster_quiz_run_once_cookie" style="margin-top: 10px;">
                                                    <label>
                                                        <input type="checkbox" value="1"
                                                               name="quizRunOnceCookie" <?php echo $this->quiz->isQuizRunOnceCookie() ? 'checked="checked"' : '' ?>>
                                                        <?php _e('user identification by cookie', 'quizmaster'); ?>
                                                    </label>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Show only specific number of questions', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                            ...
                                            <div id="quizMaster_showMaxBox" style="display: none;">
                                                <label>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Prerequisites', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Prerequisites', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                                                <input type="checkbox" value="1"
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php _e('Question overview', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Question overview', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                                                <input type="checkbox" value="1"
                                            ...
                                            <div class="quizMaster_demoBox">
                                                <?php _e('Question overview', 'quizmaster'); ?>: <a
                                                    href="#"><?php _e('Demo', 'quizmaster'); ?></a>
                                                ...
                                                <div
                                                    ...
                                                    <img alt=""
                                                         src="<?php echo QUIZMASTER_URL . '/img/questionOverview.png'; ?> ">
                                                </div>
                                            </div>
                                            <div class="quizMaster_demoBox">
                                                <?php _e('Quiz-summary', 'quizmaster'); ?>: <a
                                                    href="#"><?php _e('Demo', 'quizmaster'); ?></a>

                                                <div
                                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                                    <img alt=""
                                                         src="<?php echo QUIZMASTER_URL . '/img/quizSummary.png'; ?> ">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </td>
                                </tr>
                                <tr class="quizMaster_reviewQuestionOptions" style="display: none;">
                                    <th scope="row">
                                        <?php _e('Quiz-summary', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Quiz-summary', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                                                <input type="checkbox" value="1"
                                ...
                                <tr class="quizMaster_reviewQuestionOptions" style="display: none;">
                                    <th scope="row">
                                        <?php _e('Skip question', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Skip question', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                                                <input type="checkbox" value="1"
							...
							<tr>
								<th scope="row">
									<?php _e('Admin e-mail notification', 'quizmaster'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('Admin e-mail notification', 'quizmaster'); ?></span>
										</legend>
										<label>
											<input type="radio" name="emailNotification" value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_NONE; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                    QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_NONE); ?>>
											<?php _e('Deactivate', 'quizmaster'); ?>
										</label>
										<label>
											<input type="radio" name="emailNotification" value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                    QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER); ?>>
											<?php _e('for registered users only', 'quizmaster'); ?>
										</label>
										<label>
											<input type="radio" name="emailNotification" value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_ALL; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                    QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_ALL); ?>>
											<?php _e('for all users', 'quizmaster'); ?>
										</label>
										<p class="description">
							...
							<tr>
								<th scope="row">
									<?php _e('User e-mail notification', 'quizmaster'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('User e-mail notification', 'quizmaster'); ?></span>
										</legend>
										<label>
							 ...
							 -->
                                <tr>
                                    <th scope="row">
                                        <?php _e('Autostart', 'quizmaster'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Autostart', 'quizmaster'); ?></span>
                                            </legend>
                                            <label>
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Quiz description', 'quizmaster'); ?><?php _e('(required)',
                                'quizmaster'); ?></h3>

                        <div class="inside">
                            <p class="description">
                                <?php _e('This text will be displayed before start of the quiz.', 'quizmaster'); ?>
                            </p>
                            <?php
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Results text', 'quizmaster'); ?><?php _e('(optional)',
                                'quizmaster'); ?></h3>
                        ...
                        <div class="inside">
                            ...
                            <div style="padding-top: 10px; padding-bottom: 10px;">
                                <label for="quizMaster_resultGradeEnabled">
                                    <?php _e('Activate graduation', 'quizmaster'); ?>
                                    <input type="checkbox" name="resultGradeEnabled" id="quizMaster_resultGradeEnabled"
                                           value="1" <?php echo $this->quiz->isResultGradeEnabled() ? 'checked="checked"' : ''; ?>>
                                </label>
                            </div>
                            <div style="display: none;" id="resultGrade">
                                <div>
                                    <strong><?php _e('Hint:', 'quizmaster'); ?></strong>
                                    <ul style="list-style-type: square; padding: 5px; margin-left: 20px; margin-top: 0;">
                                        <li><?php _e('Maximal 15 levels', 'quizmaster'); ?></li>
                                        <li>
                                        ...
                                        <li><?php _e('Values can also be mixed up', 'quizmaster'); ?></li>
                                ...
                                <div>
                                            ...
                                            if ($this->quiz->isResultGradeEnabled() && isset($resultText['text'][$i])) {
                                                ...
                                                <li style="padding: 5px; border: 1px dotted;">
                                                    ...
                                                    <div
                                                        ...
                                                        <?php _e('from:', 'quizmaster'); ?> <input type="text"
                                                                                                    name="resultTextGrade[prozent][]"
                                                                                                    class="small-text"
                                                                                                    value="<?php echo $resultText['prozent'][$i] ?>"> <?php _e('percent',
                                                            'quizmaster'); ?> <?php printf(__('(Will be displayed, when result-percent is >= <span class="resultProzent">%s</span>%%)',
                                                            'quizmaster'), $resultText['prozent'][$i]); ?>
                                                        <input type="button" style="float: right;"
                                                               class="button-primary deleteResult"
                                                               value="<?php _e('Delete graduation', 'quizmaster'); ?>">
                                    ...
                                    <input type="button" class="button-primary addResult"
                                           value="<?php _e('Add graduation', 'quizmaster'); ?>">
                                </div>
                            </div>
                            <div id="resultNormal">
                                <?php
                            ...
                            <h4><?php _e('Custom fields - Variables', 'quizmaster'); ?></h4>
    ...
    private function resultOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Result-Options', 'quizmaster'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show average points', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show average points', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <p class="description">
                                    <?php _e('Statistics-function must be enabled.', 'quizmaster'); ?>
                                </p>
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt="" src="<?php echo QUIZMASTER_URL . '/img/averagePoints.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show category score', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show category score', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                            ...
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/catOverview.png'; ?> ">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct questions - display', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct questions - display', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                            ...
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/hideCorrectQuestion.png'; ?> ">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Hide quiz time - display', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide quiz time - display', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                            ...
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/hideQuizTime.png'; ?> ">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Hide score - display', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide score - display', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                            ...
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/hideQuizPoints.png'; ?> ">
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    private function questionOptions()
    {
        ...
        <div class="postbox">
            <h3 class="hndle"><?php _e('Question-Options', 'quizmaster'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show points', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show points', 'quizmaster'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Number answers', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Number answers', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt="" src="<?php echo QUIZMASTER_URL . '/img/numbering.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct- and incorrect message', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct- and incorrect message', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt=""
                                             src="<?php echo QUIZMASTER_URL . '/img/hideAnswerMessageBox.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Correct and incorrect answer mark', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Correct and incorrect answer mark', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt="" src="<?php echo QUIZMASTER_URL . '/img/mark.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Force user to answer each question', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Force user to answer each question', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question position overview', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question position overview', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt=""
                                             src="<?php echo QUIZMASTER_URL . '/img/hideQuestionPositionOverview.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question numbering', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question numbering', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt=""
                                             src="<?php echo QUIZMASTER_URL . '/img/hideQuestionNumbering.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display category', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display category', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="quizMaster_demoBox">
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt="" src="<?php echo QUIZMASTER_URL . '/img/showCategory.png'; ?> ">
                                    </div>
                                </div>
                            </fieldset>
                        </td>
    ...
    private function leaderboardOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Leaderboard', 'quizmaster'); ?><?php _e('(optional)', 'quizmaster'); ?></h3>
            ...
            <div class="inside">
                ...
                <p>
                    <?php _e('The leaderboard works independent from internal statistics function.', 'quizmaster'); ?>
                </p>
                <table class="form-table">
                    <tbody id="toplistBox">
                    <tr>
                        <th scope="row">
                            <?php _e('Leaderboard', 'quizmaster'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Who can sign up to the list', 'quizmaster'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('insert automatically', 'quizmaster'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('display captcha', 'quizmaster'); ?>
                        </th>
                        <td>
                            <label>
                            ...
                            <p class="description" style="color: red;">
                                <?php _e('This option requires additional plugin:', 'quizmaster'); ?>
                                <a href="http://wordpress.org/extend/plugins/really-simple-captcha/" target="_blank">Really
                                    Simple CAPTCHA</a>
                            </p>
                            <?php if ($this->captchaIsInstalled) { ?>
                                <p class="description" style="color: green;">
                                    <?php _e('Plugin has been detected.', 'quizmaster'); ?>
                                </p>
                            <?php } else { ?>
                                <p class="description" style="color: red;">
                                    <?php _e('Plugin is not installed.', 'quizmaster'); ?>
                                </p>
                            <?php } ?>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('How many entries should be displayed', 'quizmaster'); ?>
                        </th>
                        <td>
                            <div>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Automatically display leaderboard in quiz result', 'quizmaster'); ?>
                        </th>
                        <td>
                            <div style="margin-top: 6px;">
                                <?php _e('Where should leaderboard be displayed:', 'quizmaster'); ?>
                                <label style="margin-right: 5px; margin-left: 5px;">
                                    <input type="radio" name="toplistDataShowIn"
                                           value="0" <?php echo ($this->quiz->getToplistDataShowIn() == 0) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('don\'t display', 'quizmaster'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="toplistDataShowIn"
                                           value="1" <?php echo ($this->quiz->getToplistDataShowIn() == 1) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('below the "result text"', 'quizmaster'); ?>
                                </label>
									<span class="quizMaster_demoBox" style="margin-right: 5px;">
										<a href="#"><?php _e('Demo', 'quizmaster'); ?></a> 
										<span
                                            style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
											<img alt=""
                                                 src="<?php echo QUIZMASTER_URL . '/img/leaderboardInResultText.png'; ?> ">
										</span>
									</span>
                                <label>
                                    <input type="radio" name="toplistDataShowIn"
                                           value="2" <?php echo ($this->quiz->getToplistDataShowIn() == 2) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('in a button', 'quizmaster'); ?>
                                </label>
									<span class="quizMaster_demoBox">
										<a href="#"><?php _e('Demo', 'quizmaster'); ?></a> 
										<span
                                            style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
											<img alt=""
                                                 src="<?php echo QUIZMASTER_URL . '/img/leaderboardInButton.png'; ?> ">
										</span>
									</span>
                            </div>
                        </td>
    ...
    private function quizMode()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz-Mode', 'quizmaster'); ?><?php _e('(required)', 'quizmaster'); ?></h3>

            <div class="inside">
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #A0A0A0;"
                       class="quizMaster_quizModus">
                    <thead>
                    <tr>
                        <th style="width: 25%;"><?php _e('Normal', 'quizmaster'); ?></th>
                        <th style="width: 25%;"><?php _e('Normal + Back-Button', 'quizmaster'); ?></th>
                        <th style="width: 25%;"><?php _e('Check -> continue', 'quizmaster'); ?></th>
                        <th style="width: 25%;"><?php _e('Questions below each other', 'quizmaster'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td><label><input type="radio" name="quizModus"
                                    ...
                                    QuizMaster_Model_Quiz::QUIZ_MODUS_NORMAL); ?>> <?php _e('Activate',
                                    'quizmaster'); ?></label></td>
                        <td><label><input type="radio" name="quizModus"
                                          value="1" <?php $this->checked($this->quiz->getQuizModus(),
                                    QuizMaster_Model_Quiz::QUIZ_MODUS_BACK_BUTTON); ?>> <?php _e('Activate',
                                    'quizmaster'); ?></label></td>
                        <td><label><input type="radio" name="quizModus"
                                          value="2" <?php $this->checked($this->quiz->getQuizModus(),
                                    QuizMaster_Model_Quiz::QUIZ_MODUS_CHECK); ?>> <?php _e('Activate', 'quizmaster'); ?>
                            </label></td>
                        <td><label><input type="radio" name="quizModus"
                                          value="3" <?php $this->checked($this->quiz->getQuizModus(),
                                    QuizMaster_Model_Quiz::QUIZ_MODUS_SINGLE); ?>> <?php _e('Activate',
                                    'quizmaster'); ?></label></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <?php _e('Allows to use the back button in a question.', 'quizmaster'); ?>
                        </td>
                        <td>
                            <?php _e('Shows "right or wrong" after each question.', 'quizmaster'); ?>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/normal.png'; ?> ">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="quizMaster_demoBox">
                                ...
                                <div
                                    style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/backButton.png'; ?> ">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="quizMaster_demoBox" style="position: relative;">
                                <a href="#"><?php _e('Demo', 'quizmaster'); ?></a>
                                ...
                                <div
                                    ...
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/checkCcontinue.png'; ?> ">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="quizMaster_demoBox" style="position: relative;">
                                ...
                                <div
                                    style="z-index: 9999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                    <img alt="" src="<?php echo QUIZMASTER_URL . '/img/singlePage.png'; ?> ">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <?php _e('How many questions to be displayed on a page:', 'quizmaster'); ?><br>
                            <input type="number" name="questionsPerPage"
                                   value="<?php echo $this->quiz->getQuestionsPerPage(); ?>" min="0">
									<span class="description">
										<?php _e('(0 = All on one page)', 'quizmaster'); ?>
									</span>
                        </td>
                    </tr>
                    </tbody>
    ...
    private function form()
    {
        ...
        if (!count($forms)) {
            $forms = array(new QuizMaster_Model_Form(), new QuizMaster_Model_Form());
        } else {
            array_unshift($forms, new QuizMaster_Model_Form());
        }
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <p class="description">
                    <?php _e('The statistic function have to be enabled.', 'quizmaster'); ?>
                </p>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Custom fields enable', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Custom fields enable', 'quizmaster'); ?></span>
                                </legend>
                                <label>
                                ...
                                <p class="description">
                                    <?php _e('If you enable this option, custom fields are enabled.', 'quizmaster'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Display position', 'quizmaster'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display position', 'quizmaster'); ?></span>
                                </legend>
                                <?php _e('Where should the fileds be displayed:', 'quizmaster'); ?>
                                <label>
                                    <input type="radio"
                                           value="<?php echo QuizMaster_Model_Quiz::QUIZ_FORM_POSITION_START; ?>"
                                           name="formShowPosition" <?php $this->checked($this->quiz->getFormShowPosition(),
                                        QuizMaster_Model_Quiz::QUIZ_FORM_POSITION_START); ?>>
                                    <?php _e('On the quiz startpage', 'quizmaster'); ?>

                                    <div style="display: inline-block;" class="quizMaster_demoBox">
                                        <a href="#"><?php _e('Demo', 'quizmaster'); ?></a>

                                        <div
                                            style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                            <img alt=""
                                                 src="<?php echo QUIZMASTER_URL . '/img/customFieldsFront.png'; ?> ">
                                        </div>
                                    </div>
                                ...
                                <label>
                                    <input type="radio"
                                           value="<?php echo QuizMaster_Model_Quiz::QUIZ_FORM_POSITION_END; ?>"
                                           name="formShowPosition" <?php $this->checked($this->quiz->getFormShowPosition(),
                                        QuizMaster_Model_Quiz::QUIZ_FORM_POSITION_END); ?> >
                                    <?php _e('At the end of the quiz (before the quiz result)', 'quizmaster'); ?>
                                    ...
                                    <div style="display: inline-block;" class="quizMaster_demoBox">
                                        ...
                                        <div
                                            style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                            <img alt=""
                                                 src="<?php echo QUIZMASTER_URL . '/img/customFieldsEnd1.png'; ?> ">
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: inline-block;" class="quizMaster_demoBox">
                                        ...
                                        <div
                                            style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                            <img alt=""
                                                 src="<?php echo QUIZMASTER_URL . '/img/customFieldsEnd2.png'; ?> ">
                                        </div>
                                    </div>
                ...
                <div style="margin-top: 10px; padding: 10px; border: 1px solid #C2C2C2;">
                    <table style=" width: 100%; text-align: left; " id="form_table">
                        ...
                        <tr>
                            <th>#ID</th>
                            <th><?php _e('Field name', 'quizmaster'); ?></th>
                            <th><?php _e('Type', 'quizmaster'); ?></th>
                            <th><?php _e('Required?', 'quizmaster'); ?></th>
                            <th>
                                <?php _e('Show in statistic table?', 'quizmaster'); ?>
                                <div style="display: inline-block;" class="quizMaster_demoBox">
                                    <a href="#"><?php _e('Demo', 'quizmaster'); ?></a>
                                    ...
                                    <div
                                        style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
                                        <img alt=""
                                             src="<?php echo QUIZMASTER_URL . '/img/formStatisticOverview.png'; ?> ">
                                    </div>
                                </div>
                            </th>
                            <th></th>
                        ...
                        <?php foreach ($forms as $form) {
                            $checkType = $this->selectedArray($form->getType(), array(
                                QuizMaster_Model_Form::FORM_TYPE_TEXT,
                                QuizMaster_Model_Form::FORM_TYPE_TEXTAREA,
                                QuizMaster_Model_Form::FORM_TYPE_CHECKBOX,
                                QuizMaster_Model_Form::FORM_TYPE_SELECT,
                                QuizMaster_Model_Form::FORM_TYPE_RADIO,
                                QuizMaster_Model_Form::FORM_TYPE_NUMBER,
                                QuizMaster_Model_Form::FORM_TYPE_EMAIL,
                                QuizMaster_Model_Form::FORM_TYPE_YES_NO,
                                QuizMaster_Model_Form::FORM_TYPE_DATE
                            ));
                            ?>
                            <tr <?php echo $index++ == 0 ? 'style="display: none;"' : '' ?>>
                                ...
                                <td style="position: relative;">
                                    <select name="form[][type]">
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_TEXT; ?>" <?php echo $checkType[0]; ?>><?php _e('Text',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_TEXTAREA; ?>" <?php echo $checkType[1]; ?>><?php _e('Textarea',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_CHECKBOX; ?>" <?php echo $checkType[2]; ?>><?php _e('Checkbox',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_SELECT; ?>" <?php echo $checkType[3]; ?>><?php _e('Drop-Down menu',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_RADIO; ?>" <?php echo $checkType[4]; ?>><?php _e('Radio',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_NUMBER; ?>" <?php echo $checkType[5]; ?>><?php _e('Number',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_EMAIL; ?>" <?php echo $checkType[6]; ?>><?php _e('Email',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_YES_NO; ?>" <?php echo $checkType[7]; ?>><?php _e('Yes/No',
                                                'quizmaster'); ?></option>
                                        <option
                                            value="<?php echo QuizMaster_Model_Form::FORM_TYPE_DATE; ?>" <?php echo $checkType[8]; ?>><?php _e('Date',
                                                'quizmaster'); ?></option>
                                    </select>

                                    <a href="#" class="editDropDown"><?php _e('Edit list', 'quizmaster'); ?></a>
                                    ...
                                    <div class="dropDownEditBox"
                                        ...
                                        <h4><?php _e('One entry per line', 'quizmaster'); ?></h4>
                                        ...
                                        <input type="button" value="<?php _e('OK', 'quizmaster'); ?>"
                                               class="button-primary">
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="button" name="form_delete"
                                           value="<?php _e('Delete', 'quizmaster'); ?>" class="button-secondary">
                    ...
                    <div style="margin-top: 10px;">
                        <input type="button" name="form_add" id="form_add"
                               value="<?php _e('Add field', 'quizmaster'); ?>" class="button-secondary">
                    </div>
                </div>
            </div>
        </div>
    ...
    {
        /** @var QuizMaster_Model_Email * */
        $email = $this->quiz->getAdminEmail();
        $email = $email === null ? QuizMaster_Model_Email::getDefault(true) : $email;
        ?>
                            ...
                            <fieldset>
                                ...
                                <label>
                                    <input type="radio" name="emailNotification"
                                           value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_NONE; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                        QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_NONE); ?>>
                                    <?php _e('Deactivate', 'quizmaster'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="emailNotification"
                                           value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                        QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER); ?>>
                                    <?php _e('for registered users only', 'quizmaster'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="emailNotification"
                                           value="<?php echo QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_ALL; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                        QuizMaster_Model_Quiz::QUIZ_EMAIL_NOTE_ALL); ?>>
                                    <?php _e('for all users', 'quizmaster'); ?>
                                </label>
                        ...
                        <td>
                            ...
                            <div style="padding-top: 10px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <th style="padding: 0;">
                                            <?php _e('Allowed variables', 'quizmaster'); ?>
                                        </th>
                                        <th style="padding: 0;">
                                            <?php _e('Custom fields - Variables', 'quizmaster'); ?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td style="vertical-align: top;">
                                            <ul>
                                                ...
                                                <li><span>$username</span> - <?php _e('Username', 'quizmaster'); ?>
                                                </li>
                                                <li><span>$quizname</span> - <?php _e('Quiz-Name', 'quizmaster'); ?>
                                                </li>
                                                <li><span>$result</span> - <?php _e('Result in precent',
                                                        'quizmaster'); ?></li>
                                                <li><span>$points</span> - <?php _e('Reached points', 'quizmaster'); ?>
                                                </li>
    ...
    private function userEmailOption()
    {
        ...
        $email = $email === null ? QuizMaster_Model_Email::getDefault(false) : $email;
        $to = $email->getTo();
        ?>
