...
= Support =
* English: https://goldhat.ca/plugins/quizmaster
...
* Added gulp support
* Fix #7 - compatibility with All In One WP Security (https://github.com/goldhat/QuizMaster/issues/7)
* Fix #5 - order of questions changes (https://github.com/goldhat/QuizMaster/issues/5)
* Merge pull request #6 - escape double quotes that breaks <input> tag (https://github.com/goldhat/QuizMaster/pull/6)
* Translation for polish have been added (Thanks Behrooz N.)

= 0.36 =
* Fix #3 (Missing translation) (https://github.com/goldhat/QuizMaster/issues/3)
* Fix #2 - Free Answer: "0" Answer is marked as incorrect (https://github.com/goldhat/QuizMaster/issues/2)
