<?php
/*
Plugin Name: QuizMaster Pro
Plugin URI: http://wordpress.org/extend/plugins/quizmaster-pro
...
Text Domain: quizmaster-pro
Domain Path: /languages
*/

define('QUIZMASTER_VERSION', '0.0.2');
...
function quizmasterTestForACF() {
  ...
  if( !$isAcfActive ) {
    ...
    wp_die( __( 'QuizMaster Pro requires ACF Pro! Visit <a href="https://www.advancedcustomfields.com/">https://www.advancedcustomfields.com/</a> to purchase or
